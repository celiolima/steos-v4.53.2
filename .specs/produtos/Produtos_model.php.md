# Documentação: Produtos_model.php

## 1. Identificação
- **Caminho:** `e:\DEV\EMISSOR DE NOTAS\STEOS\application\models\Produtos_model.php`
- **Tipo:** Model
- **Módulo:** produtos

## 2. Propósito
Responsável pelo processamento e lógica pertinente à camada de Model do módulo de produtos.
...
### Método: `updateEstoque`
- **Parâmetros:** `$produto, $quantidade, $operacao = '-'`
- **Lógica Principal:** Gerencia o fluxo para a funcionalidade `updateEstoque`.
