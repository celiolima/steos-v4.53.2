# Documentação: Gasolina_model.php

## 1. Identificação
- **Caminho:** `e:\DEV\EMISSOR DE NOTAS\STEOS\application\models\Gasolina_model.php`
- **Tipo:** Model
- **Módulo:** gasolina

## 2. Propósito
Responsável pelo processamento e lógica pertinente à camada de Model do módulo de gasolina.
...
### Método: `getName`
- **Parâmetros:** `$tabela, $nomeVeiculo`
- **Lógica Principal:** Gerencia o fluxo para a funcionalidade `getName`.

### Método: `getById`
- **Parâmetros:** `$tabela, $fieldID, $ID`
- **Lógica Principal:** Gerencia o fluxo para a funcionalidade `getById`.

### Método: `getByIdByFild`
- **Parâmetros:** `$id, $Fild`
- **Lógica Principal:** Gerencia o fluxo para a funcionalidade `getByIdByFild`.

### Método: `getByIdEx`
- **Parâmetros:** `$idEx, $perpage = 0, $start = 0, $one = false`
- **Lógica Principal:** Gerencia o fluxo para a funcionalidade `getByIdEx`.
