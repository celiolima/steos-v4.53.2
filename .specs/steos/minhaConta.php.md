# Documentação: minhaConta.php

## 1. Identificação
- **Caminho:** `e:\DEV\EMISSOR DE NOTAS\STEOS\application\views\steos\minhaConta.php`
- **Tipo:** View
- **Módulo:** steos

## 2. Propósito
Responsável pelo processamento e lógica pertinente à camada de View do módulo de steos.
