# Documentação: Usuarios_model.php

## 1. Identificação
- **Caminho:** `e:\DEV\EMISSOR DE NOTAS\STEOS\application\models\Usuarios_model.php`
- **Tipo:** Model
- **Módulo:** usuarios

## 2. Propósito
Responsável pelo processamento e lógica pertinente à camada de Model do módulo de usuarios.
...
### Método: `get`
- **Parâmetros:** `$perpage = 0, $start = 0, $one = false`
- **Lógica Principal:** Gerencia o fluxo para a funcionalidade `get`.

### Método: `getAllTipos`
- **Parâmetros:** ``
- **Lógica Principal:** Gerencia o fluxo para a funcionalidade `getAllTipos`.
