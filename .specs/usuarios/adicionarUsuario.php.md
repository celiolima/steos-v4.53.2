# Documentação: adicionarUsuario.php

## 1. Identificação
- **Caminho:** `e:\DEV\EMISSOR DE NOTAS\STEOS\application\views\usuarios\adicionarUsuario.php`
- **Tipo:** View
- **Módulo:** usuarios

## 2. Propósito
Responsável pelo processamento e lógica pertinente à camada de View do módulo de usuarios.
