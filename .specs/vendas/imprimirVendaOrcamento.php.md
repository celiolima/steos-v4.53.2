# Documentação: imprimirVendaOrcamento.php

## 1. Identificação
- **Caminho:** `e:\DEV\EMISSOR DE NOTAS\STEOS\application\views\vendas\imprimirVendaOrcamento.php`
- **Tipo:** View
- **Módulo:** vendas

## 2. Propósito
Responsável pelo processamento e lógica pertinente à camada de View do módulo de vendas.
