# Documentação: Email.php

## 1. Identificação
- **Caminho:** `e:\DEV\EMISSOR DE NOTAS\STEOS\application\controllers\Email.php`
- **Tipo:** Controller
- **Módulo:** email

## 2. Propósito
Responsável pelo processamento e lógica pertinente à camada de Controller do módulo de email.
...
### Método: `process`
- **Parâmetros:** ``
- **Lógica Principal:** Gerencia o fluxo para a funcionalidade `process`.

### Método: `retry`
- **Parâmetros:** ``
- **Lógica Principal:** Gerencia o fluxo para a funcionalidade `retry`.
...
Mapeamento automático via CodeIgniter: `site_url('email/metodo')`.
