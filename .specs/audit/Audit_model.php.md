# Documentação: Audit_model.php

## 1. Identificação
- **Caminho:** `e:\DEV\EMISSOR DE NOTAS\STEOS\application\models\Audit_model.php`
- **Tipo:** Model
- **Módulo:** audit

## 2. Propósito
Responsável pelo processamento e lógica pertinente à camada de Model do módulo de audit.
