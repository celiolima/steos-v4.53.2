# Documentação: adicionarCliente.php

## 1. Identificação
- **Caminho:** `e:\DEV\EMISSOR DE NOTAS\STEOS\application\views\clientes\adicionarCliente.php`
- **Tipo:** View
- **Módulo:** clientes

## 2. Propósito
Responsável pelo processamento e lógica pertinente à camada de View do módulo de clientes.
