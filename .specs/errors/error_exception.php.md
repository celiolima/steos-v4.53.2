# Documentação: error_exception.php

## 1. Identificação
- **Caminho:** `e:\DEV\EMISSOR DE NOTAS\STEOS\application\views\errors\html\error_exception.php`
- **Tipo:** View
- **Módulo:** errors

## 2. Propósito
Responsável pelo processamento e lógica pertinente à camada de View do módulo de errors.
