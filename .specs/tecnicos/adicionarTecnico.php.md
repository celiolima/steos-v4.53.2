# Documentação: adicionarTecnico.php

## 1. Identificação
- **Caminho:** `e:\DEV\EMISSOR DE NOTAS\STEOS\application\views\tecnicos\adicionarTecnico.php`
- **Tipo:** View
- **Módulo:** tecnicos

## 2. Propósito
Responsável pelo processamento e lógica pertinente à camada de View do módulo de tecnicos.
