# Documentação: adicionarServico.php

## 1. Identificação
- **Caminho:** `e:\DEV\EMISSOR DE NOTAS\STEOS\application\views\servicos\adicionarServico.php`
- **Tipo:** View
- **Módulo:** servicos

## 2. Propósito
Responsável pelo processamento e lógica pertinente à camada de View do módulo de servicos.
