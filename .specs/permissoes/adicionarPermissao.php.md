# Documentação: adicionarPermissao.php

## 1. Identificação
- **Caminho:** `e:\DEV\EMISSOR DE NOTAS\STEOS\application\views\permissoes\adicionarPermissao.php`
- **Tipo:** View
- **Módulo:** permissoes

## 2. Propósito
Responsável pelo processamento e lógica pertinente à camada de View do módulo de permissoes.
