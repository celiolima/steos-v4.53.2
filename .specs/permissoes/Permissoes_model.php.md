# Documentação: Permissoes_model.php

## 1. Identificação
- **Caminho:** `e:\DEV\EMISSOR DE NOTAS\STEOS\application\models\Permissoes_model.php`
- **Tipo:** Model
- **Módulo:** permissoes

## 2. Propósito
Responsável pelo processamento e lógica pertinente à camada de Model do módulo de permissoes.
...
### Método: `getActive`
- **Parâmetros:** `$table, $fields`
- **Lógica Principal:** Gerencia o fluxo para a funcionalidade `getActive`.
