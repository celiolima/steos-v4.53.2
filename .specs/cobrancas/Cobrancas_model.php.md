# Documentação: Cobrancas_model.php

## 1. Identificação
- **Caminho:** `e:\DEV\EMISSOR DE NOTAS\STEOS\application\models\Cobrancas_model.php`
- **Tipo:** Model
- **Módulo:** cobrancas

## 2. Propósito
Responsável pelo processamento e lógica pertinente à camada de Model do módulo de cobrancas.
...
### Método: `getByOs`
- **Parâmetros:** `$id`
- **Lógica Principal:** Gerencia o fluxo para a funcionalidade `getByOs`.

### Método: `getByVendas`
- **Parâmetros:** `$id`
- **Lógica Principal:** Gerencia o fluxo para a funcionalidade `getByVendas`.
...
- **Parâmetros:** `$idCobranca`
- **Lógica Principal:** Gerencia o fluxo para a funcionalidade `atualizarStatus`.

### Método: `confirmarPagamento`
- **Parâmetros:** `$idCobranca`
- **Lógica Principal:** Gerencia o fluxo para a funcionalidade `confirmarPagamento`.

### Método: `cancelarPagamento`
- **Parâmetros:** `$idCobranca`
- **Lógica Principal:** Gerencia o fluxo para a funcionalidade `cancelarPagamento`.

### Método: `enviarEmail`
- **Parâmetros:** `$idCobranca`
- **Lógica Principal:** Gerencia o fluxo para a funcionalidade `enviarEmail`.
