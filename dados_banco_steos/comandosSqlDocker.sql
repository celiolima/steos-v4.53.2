...
Get-Content "e:\DEV\EMISSOR DE NOTAS\STEOS\dados_banco_steos\dados_steos.sql" -Encoding UTF8 -Raw | docker exec -i steos_mysql mysql -u steos -psteos --default-character-set=utf8mb4 --init-command="SET NAMES utf8mb4;" steos -- importa os dados
