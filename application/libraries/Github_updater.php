...
class Github_updater
{
    ...
    public function update()
    {
        ...
        if ($hash !== $this->ci->config->item('current_commit')) {
            ...
            if ($dir = $this->_get_and_extract($hash)) {
                ...
                // Update the steos version in the config filename
    ...
    /**
     * Get steos current version.
     *
     * @return string Steos current version.
     */
    private function getCurrentVersion()
    {
        ...
        if (! $version) {
            throw new Exception('Error getting steos version from GitHub!');
        }
