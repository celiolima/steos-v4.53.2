...
<div class="document-container">
    ...
    <div class="client-row">
        ...
        <div contenteditable="true" class="editable-cell"><?php echo $result->nomeCliente; ?> (Contrato: <?php echo $result->nomeContratos; ?>)</div>
    </div>
...
<script>
    ...
    document.querySelectorAll('.clickable-cell').forEach(cell => {
        cell.addEventListener('click', function() {
            if (this.textContent === '') {
                this.textContent = 'V';
                this.className = 'clickable-cell status-v';
            } else if (this.textContent === 'V') {
                this.textContent = 'X';
                this.className = 'clickable-cell status-x';
            } else {
                this.textContent = '';
                this.className = 'clickable-cell';
            }
        });
    });
