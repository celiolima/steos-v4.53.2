...
<body>
  <div class="main-login">
    <div class="left-login">
      ...
      <h2 class="h-two"> Ao Sistema de Controle de Ordens de Serviços</h2>
      <img src="<?php echo base_url() ?>assets/img/login.png" class="left-login-image" alt="Map-OS - Versão: <?= $this->config->item('app_version'); ?>">
    </div>
    <div id="loginbox">
        ...
        submitHandler: function(form) {
          ...
          $.ajax({
            ...
            success: function(data) {
              if (data.result == true) {
                window.location.href = "<?= site_url('steos'); ?>";
              } else {
                
                if(data.STEOS_TOKEN){
                   $('[name="<?= $this->security->get_csrf_token_name(); ?>"]').val(data.STEOS_TOKEN);
                }
