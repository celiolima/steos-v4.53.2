                            ...
                            <div class="span8">
                                <div class="span9" style="display:flex">
                                    ...
                                    <button href="#modal-confirmaratualiza" data-toggle="modal" type="button" class="button btn btn-danger">
                                      <span class="button__icon"><i class="bx bx-sync"></i></span><span class="button__text2">Atualizar Steos</span></button>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="control-group">
                            ...
                            <div class="span8">
                                ...
                                <div class="span10" style="margin-left: 3em;">
                                    ...
                                    <label> <input <?= @in_array("A Sair | Aguard Conclusão", json_decode($configuration['os_status_list'])) == 'true' ? 'checked' : ''; ?> name="os_status_list[]" class="marcar" type="checkbox" value="A Sair | Aguard Conclusão"> <span class="lbl"> A Sair | Aguard Conclusão</span> </label>
                                    <label> <input <?= @in_array("Manutenção Preventiva", json_decode($configuration['os_status_list'])) == 'true' ? 'checked' : ''; ?> name="os_status_list[]" class="marcar" type="checkbox" value="Manutenção Preventiva"> <span class="lbl"> Manutenção Preventiva</span> </label>
                                </div>
                            </div>
                            <div class="span8">
...
<div id="modal-confirmaratualiza" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <form action="<?php echo base_url() ?>index.php/clientes/excluir" method="post">
        ...
        <div class="modal-footer" style="display:flex;justify-content: center">
          ...
          <button id="update-steos" type="button" class="button btn btn-warning"><span class="button__icon"><i class="bx bx-sync"></i></span><span class="button__text2">Atualizar</span></button>
        </div>
    </form>
</div>
<!-- Modal -->
    ...
    <form action="<?php echo base_url() ?>index.php/clientes/excluir" method="post">
        ...
        <div class="modal-body">
            ...
            <h7 style="text-align: left">Recomendamos que faça um backup antes de prosseguir!
                <a target="_blank" title="Fazer Bakup" class="btn btn-mini btn-inverse" href="<?php echo site_url() ?>/steos/backup">Fazer Backup</a>
            </h7>
        </div>
        <div class="modal-footer" style="display:flex;justify-content: center">
          <button class="button btn btn-mini btn-danger" data-dismiss="modal" aria-hidden="true"><span class="button__icon"><i class='bx bx-x' ></i></span> <span class="button__text2">Cancelar</span></button>
...
<script>
    $('#update-database').click(function() {
        window.location = "<?= site_url('steos/atualizarBanco') ?>"
    });
    $('#update-steos').click(function() {
        window.location = "<?= site_url('steos/atualizarSteos') ?>"
    });
