...
<div class="row-fluid" style="margin-top: 0">
    ...
    <div class="new122">
        ...
        <div class="widget-title">
            <h5>Comissões de Serviços</h5>
        </div>

        <div class="span12" style="margin-left: 0">
            <form action="<?php echo base_url(); ?>index.php/relatorios/comissaoOs/" method="post">
                <div class="span2" style="margin-left: 0">
                    ...
                    <select name="tecnico" id="" class="span12">
                        ...
                        if ($this->session->userdata('permissao') == '1' || $this->session->userdata('permissao') == '2') {
                            foreach ($tecnicos as $tecnico) {
                                if ($this->input->post('tecnico') == $tecnico->nome) {
                                    echo '<option selected >' . $tecnico->nome . '</option>';
                                } else {
                ...
                <div class="span2">
                    ...
                    <div style="text-align: left"><strong>Total Serviços:</strong>
                        <strong style="text-align: right;">R$ <?php if (!empty($totalServicos)) {
                                                                    echo number_format($totalServicos, 2, ',', '.');
                                                                } ?></strong>
                    </div>

                    <div style="text-align: left"><strong>Produção tec:</strong>
                        <strong style="text-align: right;">R$ <?php if (!empty($totalServicosTecnico)) {
                                                                    echo number_format($totalServicosTecnico, 2, ',', '.');
                                                                } ?></strong>
                    </div>

                    <div style="text-align: left; color: green"><strong>Comissão:</strong>
                        <strong style="text-align: right; color: green"><?php if (!empty($totalComissaoServicos)) {
                ...
                <div class="span2 pull-right">
                    ...
                    <button type="submit" formaction="<?php echo base_url(); ?>index.php/relatorios/comissaoServicosImprimir" method="post" class="button btn btn-info btn-sm" style="min-width: 120px;margin: 0">

                        <span class="button__icon"><i class="bx bx-printer"></i></span><span class="button__text2">Imprimir</span>

                    </button>

                    <button type="button" class="button btn btn-warning btn-sm" style="min-width: 120px;margin: 0">
                        <a href=" <?php echo base_url(); ?>index.php/relatorios/comissaoOs">
                ...
                <table class="table table-bordered  ">
                    <thead>
                        <tr>
                            ...
                            <th class="ph4">Tecnico <?php if (!empty($inputGet['tecnico'])) {
                        ...
                        if (!empty($results)) {
                            ...
                            foreach ($results as $r) {
                                ...
                                /* echo "<pre> comissaoOs :<br>";
                                    print_r((float)$r['totalServicos']);
                                    echo "</pre>";
                                    exit; */

                                echo '<td class="ph4">R$ ' . (((float)$r['totalServicos'] / (float)$r['divizorComissaoServico']) * (float)$percentual) . '</td>';
                    ...
                    <tfoot>
                        <tr>
                            <td colspan="6" style="text-align: right"><strong>Total Serviços:</strong></td>
                        ...
                        <tr>
                            <td colspan="6" style="text-align: right; color: blue"><strong>Total Serviços do Tecnico:</strong></td>
