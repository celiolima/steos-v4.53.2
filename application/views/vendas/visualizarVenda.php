                            ...
                            <table class="table table-condensed">
                                <tbody>
                                    <?php if ($result->dataVenda != null): ?>
                                            ...
                                            <td><b>Status Venda: </b><?php echo $statusVenda; ?></td>
                                            <td><b>Data da Venda: </b><?php echo date('d/m/Y', strtotime($result->dataVenda)); ?></td>
                                            <td><?php if (isset($result->garantia) && $result->garantia): ?><b>Garantia: </b><?php echo $result->garantia . ' dia(s)'; ?><?php endif; ?></td>
                                            <td><?php if (in_array($statusVenda, ['Finalizado', 'Faturado', 'Orçamento', 'Aberto', 'Em Andamento', 'Aguardando Peças']) && isset($result->garantia)): ?><b>Venc. da Garantia: </b><?php echo dateInterval($result->dataVenda, $result->garantia); ?><?php endif; ?></td>
                                        </tr>
                                    <?php endif; ?>
