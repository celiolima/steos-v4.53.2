...
<div class="new122">
    ...
    <div class="widget-box">
        ...
        foreach ($results as $r) {
            ...
            if (isset($r->garantia) && $r->garantia && is_numeric($r->garantia)) {
            ...
            $statusVenda = isset($r->status) ? $r->status : 'Finalizado';
            $corStatus = match($statusVenda) {
                'Aberto' => '#00cd00',
                'Em Andamento' => '#436eee',
                'Orçamento' => '#CDB380',
                'Negociação' => '#AEB404',
            ...
            echo '<td><span class="badge" style="background-color: ' . $corStatus . '; border-color: ' . $corStatus . '">' . $statusVenda . '</span> </td>';
            echo '<td>' . $faturado . '</td>';
