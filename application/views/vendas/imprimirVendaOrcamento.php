            ...
            <header>
                <?php if ($emitente == null) : ?>
                    <div class="alert alert-danger" role="alert">
                        Você precisa configurar os dados do emitente. >>> <a href="<?=base_url()?>index.php/steos/emitente">Configurar</a>
                    </div>
                <?php else : ?>
                    <div class="imgLogo" class="align-middle">
                        <img src="<?= base_url('assets/uploads/' . basename($emitente->url_logo)) ?>" class="img-fluid" style="width:140px;">
                    </div>
                    <div class="emitente">
                ...
                <?php if ($result->dataVenda != null): ?>
                    <div class="tabela">
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                <tr>
                                    <td class="text-center"><?= isset($result->status) ? $result->status : 'Finalizado' ?></td>
                                    <td class="text-center"><?= date('d/m/Y', strtotime($result->dataVenda)) ?></td>
                                    <td class="text-center">
                                        <?php if (isset($result->garantia) && $result->garantia > 0): ?>
