<?php
class Steos_model extends CI_Model
{
    /**
     * author: Ramon Silva
    ...
    public function calendario($start, $end, $status = null, $tecnicos = null)
    {
        $this->db->select(
            'os.*,
        ...
        //$this->db->where('tecnicos_os.tecnicoName', 'Dario');
        ...
        if (!empty($tecnicos)) {
            $this->db->where('tecnicos_os.tecnicoName', $tecnicos);
        }
