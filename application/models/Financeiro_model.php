...
class Financeiro_model extends CI_Model
{
    ...
    // get1 — EXCLUSIVO STEOS: consulta sem paginação
    public function get1($table, $fields, $where = '')
    {
    ...
    // calendario — EXCLUSIVO STEOS
    public function calendario($table, $fields, $where = '')
    {
        $this->db->select($fields . ', usuarios.*');
        $this->db->from($table);
        $this->db->join('usuarios', 'usuarios.idUsuarios = usuarios_id', 'left');
